        ...
        <div className="overflow-y-auto">
          ...
          <div className="p-3 m-3 mt-0 bg-[#07131a] border-2 border-black shadow-[3px_3px_0px_#000]">
            ...
            <div className="p-2 bg-black border border-slate-800 text-center mb-2">
              <span suppressHydrationWarning className="font-mono-data text-xs text-[#00ff66] font-bold tracking-tight block">
                {formatSimTime(clock?.sim_now || '2026-09-08T14:00:00.000Z', true)}
              </span>
            </div>
